...
export default {
  ...
  watch: {
    ...
    job_post() {
      this.min_salary = this.job_post.min_salary
      this.max_salary = this.job_post.max_salary
      this.currency = this.job_post.salary_currency
      this.salary_period = this.job_post.salary_period
      this.show_salary = this.job_post.show_salary
      this.min_commission = this.job_post.min_commission
      this.max_commission = this.job_post.max_commission
    }
  },
  mounted() {
    this.getCurrencies();
